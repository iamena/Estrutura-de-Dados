...
public class MyFavoriteTeachers {
     ...
     public static void main(String[] args) {
          ...
          System.out.println("Essa é a lista sem o elemento da posição 0");
          ...
          System.out.println("Essa é a lista, quando substituimos o elemento da posiçao 3, por João Paulo");
